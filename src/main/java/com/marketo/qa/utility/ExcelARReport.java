...
public class ExcelARReport extends converting{
	...
	public static void ARReport() throws Exception {
		...
		if (WorkSpace_count>=1) {
			...
			ExcelStyling.mergeAndCenter(workbookoutput, AR_Data_Point1, "B541DF",
					"instance acct prefix: " + passData.Exceldata("Account Name"), 3, 3, 2, 3 + WorkSpace_count, false, 12);
		...
		//	Printing workspaces names 
			...
			for (int i = 1; i <= WorkSpace_count; i++)
			{
				...
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 7, coll++,
						AllCampaigns, 12);
				coll--;
				j--;
				
				int ActiveCampaigns= Integer.parseInt(passData.Exceldata("Active Campaigns", j++));
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 8, coll++,
						ActiveCampaigns, 12);
				coll--;
				j--;
				
				int AllTriggeredCampaigns= Integer.parseInt(passData.Exceldata("All Triggered Campaigns", j++));
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 9, coll++,
						AllTriggeredCampaigns, 12);
				coll--;
				j--;
				
				int ActiveTriggeredCampaigns= Integer.parseInt(passData.Exceldata("Active Triggered Campaigns", j++));
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 10, coll++,
						ActiveTriggeredCampaigns, 12);
				coll--;
				j--;
				
				int AllBatchCampaigns= Integer.parseInt(passData.Exceldata("All Batch Campaigns", j++));
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 11, coll++,
						AllBatchCampaigns, 12);
				coll--;
				j--;
				
				 int BatchCampaigns= Integer.parseInt(passData.Exceldata("Batch Campaigns - Repeating Schedule", j++));
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 12, coll++,
						BatchCampaigns, 12);	
				coll--;
				j--;
				
				int ScheduledBatchCampaigns= Integer.parseInt(passData.Exceldata("Scheduled Batch Campaigns", j++));
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 13, coll++,
						ScheduledBatchCampaigns, 12);	
				coll--;
				j--;
				...
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 18, coll++,
						LandingPages, 12);
				coll--;
				j--;
				...
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 19, coll++,
						Forms, 12);
				coll--;
				j--;
				int Emails= Integer.parseInt(passData.Exceldata("Emails", j++));
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 20, coll++,
						Emails, 12);
				coll--;
				j--;
				
				int Snippets= Integer.parseInt(passData.Exceldata("Snippets", j++));
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 21, coll++,
						Snippets, 12);
				coll--;
				j--;
				int ImagesandFiles= Integer.parseInt(passData.Exceldata("Images and Files", j++));
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 22, coll++,
						ImagesandFiles, 12);
				...
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 27, coll++,
						AllPeople, 12);								//Need to check 
				coll--;
				j--;
				int MarketableLeads= Integer.parseInt(passData.Exceldata("Marketable Leads", j++));
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 28, coll++,
						MarketableLeads, 12);                               //Need to check 
				coll--;
				j--;
				
				int PossibleDuplicates= Integer.parseInt(passData.Exceldata("Possible Duplicates", j++));
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 29, coll++,
						PossibleDuplicates, 12);
				coll--;
				j--;
				
				int UnsubscribedPeople= Integer.parseInt(passData.Exceldata("Unsubscribed People", j++));
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 30, coll++,
						UnsubscribedPeople, 12);
				coll--;
				j--;
				int MarketingSuspended= Integer.parseInt(passData.Exceldata("Marketing Suspended", j++));
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 31, coll++,
						MarketingSuspended, 12);

				

			
			//Totals of Campaigns 
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 7, 3 + WorkSpace_count,
					AllCampaigns, 12);
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 8, 3 + WorkSpace_count,
					ActiveChampaigns, 12);
			...
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 11, 3 + WorkSpace_count,
					AllBatchCampaigns, 12);
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 12, 3 + WorkSpace_count,
					BatchCampaignsRepeatingSchedule, 12);
			
			//printing Asset Data totals for multiple workspaces
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 18, 3 + WorkSpace_count,
					LandingPages, 12);
		
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 19, 3 + WorkSpace_count,
					Forms, 12);
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 20, 3 + WorkSpace_count,
					Emails, 12);
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 21, 3 + WorkSpace_count,
					Snippets, 12);
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 22, 3 + WorkSpace_count,
					ImagesandFiles, 12);
			
			//printing Database Data totals for multiple workspaces
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 27, 3 + WorkSpace_count ,
				AllPeople, 12);										//Need to check 
		
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 28, 3 + WorkSpace_count,
					MarketableLeads, 12);                              		 //Need to check 
			 
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 29, 3 + WorkSpace_count,
					PossibleDuplicates, 12);
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 30, 3 + WorkSpace_count,
					UnsubscribedPeople, 12);
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 31, 3 + WorkSpace_count,
					MarketingSuspended, 12);
			
			//Printing Program Data
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 41, 3,
					tags, 12);
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 42, 3,
					Models, 12);
			...
			ExcelStyling.mergeAndCenter(workbookoutput, AR_Data_Point1, "B541DF",
					"instance acct prefix: " + passData.Exceldata("Account Name"), 3, 3, 2, 2 + WorkSpace_count, false, 12);	

			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 7, 3,
					AllCampaigns, 12);
			
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 8, 3,
					ActiveChampaigns, 12);

			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 9, 3,
					AllTriggeredCampaigns, 12);
			
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 10, 3,
					ActiveTriggeredCampaigns, 12);
			 

			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 11, 3,
					AllBatchCampaigns, 12);
			
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 12, 3,
					BatchCampaignsRepeatingSchedule, 12);

				
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 13, 3,
					ScheduledBatchCampaigns, 12);
			...
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 18, 3 ,
					LandingPages, 12);
		
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 19, 3,
					Forms, 12);
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 20, 3,
					Emails, 12);
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 21, 3,
					Snippets, 12);
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 22, 3,
					ImagesandFiles, 12);
			
			
			//printing Database Data
			;
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 27, 3 ,
					AllPeople, 12);								
		
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 28, 3,
					MarketableLeads, 12);                               
			
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 29, 3,
					PossibleDuplicates, 12);
			
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 30, 3,
					UnsubscribedPeople, 12);
			
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point1, 31, 3,
					MarketingSuspended, 12);
	...
	public static void ArDataPoint2(XSSFSheet AR_Data_Point2,XSSFWorkbook workbookoutput) throws Exception
	{
		...
		{	
		ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 6, 3,
				InterestingMoment, 12);
		
		ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 6, 4,
				ARStringData.Intresting_moment, 12);
			...
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 6, 3,
					InterestingMoment, 12);
			try {
				ExcelStyling.pestImg(workbookoutput, AR_Data_Point2, 11, 5, passData.FetchScreenshot("Interesting Moment"));
		...
		ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 20, 3,
				lead, 12);
		
		if(lead==0) {
		ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 20, 6,
				ARStringData.No_lead, 12);
		
		}
		else if(lead<=5)
		{
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 20, 8,
					ARStringData.No_leadImprovement, 12);
		}
		...
		else if(EventCampion<=1)
		{
			...
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 37, 3,
					"yes", 14);
			try {
		...
		else if(NurtureCampaigns<=1)
		{
			...
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 47, 3,
					"yes", 14);
			try {
				ExcelStyling.pestImg(workbookoutput, AR_Data_Point2, 11, 46, passData.FetchScreenshot("Nurture campaigns"));
		...
		ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 58, 5,
			...
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 58, 3,
					"Yes", 12);
		}
		int coll =9;
		for(int i=1;i<3;i++)
		try {
			ExcelStyling.pestImg(workbookoutput, AR_Data_Point2, coll, 58, passData.FetchScreenshot("Segmentations"+i));
			coll =coll+3;
		...
		if(ProgrameLibrary.equalsIgnoreCase("true")) {
			...
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 72, 3,
					"Yes", 12);
		
		}
		else {
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 72, 5,
					ARStringData.NoProgrameLibrary, 12);
   ...
   //  String DataManagement=passData.Exceldata("Change Data Value");
		...
		if(DataManagement>0) {
			...
			ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 80, 3,
					"Yes", 12);
	    ...
	    // int integrations=passData.Exceldata("Integration");
			...
			if(Integration>0) {
				...
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 92, 3,
						"Yes", 12);
				try {
					ExcelStyling.pestImg(workbookoutput, AR_Data_Point2, 10, 90, passData.FetchScreenshot("Integration"));
				...
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 92, 5,
						ARStringData.NoIntegration, 12);
			...
			else if(RevenueModels<=1)
			{
				...
				ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 98, 3,
						"yes", 14);
			} 
			else {
			...
			try {
				ExcelStyling.pestImg(workbookoutput, AR_Data_Point2, coll, 98, passData.FetchScreenshot(passData.Exceldata(data, 2)));
				coll=coll+3;
			...
			ModelsCount = ModelsCount + 3;
				...
				for (int k = 3; k <= ModelsCount; k++) {
					...
					ExcelStyling.pestImg(workbookoutput, AR_Data_Point2, coll, 102, passData.FetchScreenshotForApprovedModels(passData.Exceldata(data, k)));
					coll= coll+7;
					}
					catch (Exception e) {
						// TODO: handle exception
			...
			//Additional Product WebPersonalization
				...
				if(passData.Exceldata("Web Personalization").equalsIgnoreCase("true")) {
					...
					ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 110, 3,
							"Yes", 12);
					
					try {
						ExcelStyling.pestImg(workbookoutput, AR_Data_Point2, 2, 121, passData.FetchScreenshot("Top Campaigns_Default"));
						ExcelStyling.pestImg(workbookoutput, AR_Data_Point2, 5, 121, passData.FetchScreenshot("Top Content_Default"));
						ExcelStyling.pestImg(workbookoutput, AR_Data_Point2, 8, 121, passData.FetchScreenshot("Top Industries_Default"));
						ExcelStyling.pestImg(workbookoutput, AR_Data_Point2, 7, 121, passData.FetchScreenshot("Top Organizations_Default"));
				...
				{
					ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 110, 5,
						ARStringData.NoWebPersonalization, 12);
				}
				else {
				...
				if(TAM.equalsIgnoreCase("true")) {
					...
					ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 112, 3,
							"Yes", 12);
					ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 141, 4,
							"Yes", 12);
					ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 143, 4,
							"Yes", 12);
					ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 145, 4,
							"Yes", 12);
					
					
					try {
						ExcelStyling.pestImg(workbookoutput, AR_Data_Point2, 2, 150, passData.FetchScreenshot("Target Account Management"));
				...
				{
					ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 112, 5,
							ARStringData.NoTAM, 12);
				}
				else {
					ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 112, 7,
							ARStringData.TMAImprovment, 12);
				...
				if(PredictiveContent.equalsIgnoreCase("true")) {
					...
					ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 114, 3,
							"Yes", 12);
					
					try {
						ExcelStyling.pestImg(workbookoutput, AR_Data_Point2, 2, 177, passData.FetchScreenshot("Predictive Content"));
				...
				{
					ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 114, 5,
							ARStringData.NoPredictiveContent, 12);
				}
				else {
					ExcelStyling.WriteExcel(workbookoutput, AR_Data_Point2, 114, 7,
							ARStringData.PredictiveContent, 12);
